      ...
      {showS1Score ? (
        ...
        <>
              ...
              return (
                <>
                  <div key={Simulation2Data.idx}>
                    <button
                      onClick={() =>
                        handleO1AnswerButtonClick(Simulation2Data.idx)
                      }
                      className={`SimulationQ1Option ${
                        selectedOptionO1 === Simulation2Data.idx
                          ? "selected"
                          : ""
                      }`}
                    >
                      {Simulation2Data.value}
                    </button>
                  </div>
                </>
              );
          ...
          <div>
            <br></br>
            <h3 className="SimulationQ1Question">
              {Simulation2Data[currentQuestion].question2}
            </h3>
          </div>
          <div>
              ...
              return (
                <>
                  <div key={Simulation2Data.idx}>
                    <button
                      onClick={() =>
                        handleO2AnswerButtonClick(Simulation2Data.idx)
                      }
                      className={`SimulationQ1Option ${
                        selectedOptionO2 === Simulation2Data.idx
                          ? "selected"
                          : ""
                      }`}
                    >
          ...
          <div>
            <br></br>
            <h3 className="SimulationQ1Question">
              {Simulation2Data[currentQuestion].question3}
            </h3>
          </div>
          <div>
              ...
              return (
                <>
                  <div key={Simulation2Data.idx}>
                    <button
                      onClick={() =>
                        handleO3AnswerButtonClick(Simulation2Data.idx)
                      }
                      className={`SimulationQ1Option ${
                        selectedOptionO3 === Simulation2Data.idx
                          ? "selected"
                          : ""
                      }`}
                    >
          ...
          <div>
            <br></br>
            <h3 className="SimulationQ1Question">
              {Simulation2Data[currentQuestion].question4}
            </h3>
          </div>
          <div>
              ...
              return (
                <>
                  <div key={Simulation2Data.idx}>
                    <button
                      onClick={() =>
                        handleO4AnswerButtonClick(Simulation2Data.idx)
                      }
                      className={`SimulationQ1Option ${
                        selectedOptionO4 === Simulation2Data.idx
                          ? "selected"
                          : ""
                      }`}
                    >
          ...
          <div>
            <br></br>
            <h3 className="SimulationQ1Question">
              {Simulation2Data[currentQuestion].Observation}
            </h3>
            <textarea
          ...
          {/* ----------------------------Btn-------------------------------- */}
          <br></br>
          <button className="Simulation2PrevBtn" onClick={handlePrevButonClick}>
            Prev
          </button>
          <button className="Simulation2NextBtn" onClick={handleNextButonClick}>
            Next
          </button>
        </>
      )}
