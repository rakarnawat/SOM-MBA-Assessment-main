...
import DDTemplate from "./DDTemplate";
import Paper from "@material-ui/core/Paper";
import DDShowNoOfQuestions from "./DDShowNoOfQuestions";
...
const DDQuetions = () => {
  ...
  let questionsLength = DDData[0].questions.length;
